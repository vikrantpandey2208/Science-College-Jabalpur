...
/*
 * Created on Fri Dec 24 2021 8:02:26 pm
 *
 * File Name fireSlotDayWise.php
 * ============================================================
 * Program for .....
 * ============================================================
 *
...
// cond = $_SERVER['REQUEST_METHOD'] === 'POST' && $_POST['slot_submit'] && isset($_POST['slot_id'])
if (true) {
    ...
    foreach ($classes as $classId) {
        $sql = "select * from level1 where level1_class_id = "
            . $classId . " and (level1_timeslot_start = " . $slotId
            . " or level1_timeslot_end = " . $slotId . ")"
            . " and level1_day_ids like '%" . $dayId . "%'";
        $result = $level1Obj->ReadCustomSql($sql);

        $table[] = $printObj->RowDataSlotWise($classObj->DecodeClass($classId), $result, false);
    }
